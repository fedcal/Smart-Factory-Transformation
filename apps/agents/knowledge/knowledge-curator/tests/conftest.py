"""Conftest for KnowledgeCurator agent tests (Phase 8, Wave 0 scaffold).
...
Real fixtures (mock Qdrant client, mock BgeM3Embedder, ingest corpus)
land with plan 08-06 (knowledge-curator implementation).
"""
...
def _set_bge_m3_cpu_device(monkeypatch: pytest.MonkeyPatch) -> None:
    """Force BGE-M3 to CPU mode in all KnowledgeCurator tests."""
