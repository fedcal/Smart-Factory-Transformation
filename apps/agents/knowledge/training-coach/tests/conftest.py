"""Conftest for TrainingCoach agent tests (Phase 8, Wave 0 scaffold).
...
Real fixtures (mock LLM backend, quiz bank fixtures, persona registry)
land with plan 08-05 (training-coach implementation).
"""
...
def _set_bge_m3_cpu_device(monkeypatch: pytest.MonkeyPatch) -> None:
    """Force BGE-M3 to CPU mode in all TrainingCoach tests."""
