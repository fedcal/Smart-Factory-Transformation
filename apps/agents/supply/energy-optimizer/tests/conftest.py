"""Conftest for EnergyOptimizer agent tests (Phase 9, Wave 0 scaffold).
...
Real fixtures (scm.energy_readings query harness, EnPI computation helpers) land
with plan 09-03 (energy-optimizer implementation).
"""
