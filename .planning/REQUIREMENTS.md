...
- [ ] **TRN-02**: `TrainingCoach` — adaptive learning su procedure, valuta competenza con quiz contestualizzati
- [ ] **TRN-03**: `ShiftHandover` — sintetizza handover di turno aggregando eventi, decisioni, alert aperti
- [ ] **TRN-04**: `DocumentationSynthesizer` — genera bozze SOP/runbook da eventi storici, sempre con HITL approval
- [ ] **TRN-05**: Tutti gli output TRN includono citazioni con `source_uri` e timestamp
