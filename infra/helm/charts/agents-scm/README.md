# agents-scm Helm Chart

Skeleton chart per il cluster Supply Chain Management (Fase 1).
...
| `image.repository` | `ghcr.io/smart-factory-transformation/sft-agents-scm` | Repository immagine |
