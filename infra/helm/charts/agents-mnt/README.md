# agents-mnt Helm Chart

Skeleton chart per il cluster Maintenance (Fase 1).
...
| `image.repository` | `ghcr.io/smart-factory-transformation/sft-agents-mnt` | Repository immagine |
