...
!!! info "Fonte autoritativa (single source of truth)"
    Questa pagina riporta fedelmente il modello STRIDE consolidato in **Phase 11**
    (`docs/security/STRIDE-threat-model.md`, v1.0, 2026-05-25). La fonte è il
    contratto di sicurezza trasversale del progetto: ogni modifica va effettuata
    lì e ripubblicata qui per evitare divergenze (DOC-11, SC-4).
...
| **Provenienza registro** | Phase 10 security register (Tampering supply-chain, adattato) |
...
| **Provenienza registro** | Phase 10 security register (JWT HS256, require_roles) |
...
| **Provenienza registro** | Phase 10 security register (adattato); Phase 11 SEC-04 |
...
| **Provenienza registro** | Phase 09 security register (HITL audit) |
...
| **Codice mappato** | `apps/factory-ui/src/app/shared/approval-card/approval-card.component.ts:MOTIVATION_MIN_LENGTH` + Phase 10 security register |
| **Provenienza registro** | Phase 10 security register (MOTIVATION_MIN, audit) |
...
| **Codice mappato** | `apps/api-gateway/src/svc_api_gateway/routers/supply_agents.py:_handle_agent_error` (righe 320-334) + Phase 10 security register |
| **Provenienza registro** | Phase 09 security register; Phase 10 security register |
...
| **Provenienza registro** | Phase 09 security register; Phase 11 CORE-03 |
...
| **Provenienza registro** | Phase 05 T-05-09-01; Phase 10 security register |
...
| **Provenienza registro** | Phase 09 security register; OWASP LLM06 (excessive agency) |
...
Per il mapping OWASP LLM Top-10 vedere [OWASP LLM](owasp-llm.md); per la panoramica di governance e AI explainability vedere [Sicurezza & Governance](index.md).
